...
function StylePreference() {
  ...
  return (
    <div className="flex flex-col select-none items-center justify-center mx-auto text-white">
      <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 xl:grid-cols-2 space-y-2 lg:justify-between md:justify-between xl:justify-between">
        <div className="space-y-4">
          <fieldset>
            <legend className="text-base text-white font-medium mb-2">Occasion</legend>
